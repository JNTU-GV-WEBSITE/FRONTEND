      ...
      <div className="allRightContent">
        ...
        <div className="allRightContentProfile">
          ...
          <div className="profileImage">
              ...
              <img src="https://jntugv.edu.in/images/9266a0f9fc226ffbf57a3beb4c6b6388/profilephotos/registrar.jpg" alt="Profile" />
          </div>
          ...
          <div className="profileDesignation">
           ...
           <h4 className="regularStyleH4">Professor in Metallurgical Engineering</h4>
          </div>
          </center>
          <hr />
          {/* Profile description */}
          <p>Email: dgs@jntugv.edu.in</p><br></br>
...
<p>❖ Executed NRB sanctioned research project titled "A A novel ECAR technique to produce AA5083 aluminum alloy with high deformation homogeneity and improved mechanical properties for naval applications". Cost of the project: Rs 33.628 Lac.</p>
