      ...
      <div className="allRightContent">
        <div className="allRightContentHeading">
            ...
            <div class="allRightContentHolderContent">
                <div class="allRightContentHolderContentProfile">
                  <center>
                    ...
                    <div class="allRightContentHolderContentProfileDesignation">
                        <h4 class="regularStyleH4">Director of IIIT & Placements </h4>
                    </div>
                    <div class="allRightContentHolderContentProfileQualification">
                        <span>Professor of  Dept. of Information Technology</span>
                    </div>
                    </center>
                </div>
                <hr/>
                <p>Email: diiipt@jntugv.edu.in</p>
                <hr/>
                <p>Dr. G. Jaya Suma, present working as a Professor in Department of Information Technology, and Director(i/c) of Industry Institute Interaction Placements & Training & Director(i/c) of Faculty Development Cell and Executive Council member of JNTUGV - Vizianagaram, AP. Completed her B.Tech (CS&SE), M.Tech (CS&T), Ph.D(CSE). Having Experience of 22 plus years Teaching, Research and Administration of Engineering Education</p>
                ...
                <p>❖	Awarded Four PhDs and Eight Scholars are working for PhD at present.</p>
