...
function ForeignUniversityRelations() {
  return (
      ...
      <div className="allRightContent">
        ...
        <div className="allRightContentProfile">
          ...
          <p>
            ...
            Having experience of 29 years in teaching, research and
            administration of engineering education. Worked as Principal, Dean,
            Professor and HoD in reputed private institutions during 1992-2012
          ...
          <p>
            ❖ Chaired several International conferences in India and abroad.
          </p>
          <p>
          ...
          <p>
            ❖ Research board member, Anna university, Vignan university,
            Integral university.
          </p>
          ...
          <p>
            ❖ Having National recognitions and associations with NAAC, NBA,
            MSME, CII, WIPRO, TCS andAICTE, learned and practiced quality SOPs
            to serve higher education in India.
          </p>
          <p>
            ❖ Identified by AICTE as one of the 200 participants across India
            for UK-India EducationResearch Initiative (UKIERI) scheme and
            completed CMI certification during 2015-16.
          </p>
          <p>❖ Visited DUDLEY college of UK-Birmingham on invitation.</p>
          <p>❖ Expert member, RIFD Bureau of AICTE.</p>
          <p>
            ❖ GB member and BoS member in reputed autonomous colleges appointed
            by JNTUK.
          </p>
          ...
          <p>
            ...
            Accord (WA) regulations during Dec2012 withProf. Unnikrishnan,
            Advisor for INDIA, Washington Accord, USA.
          </p>
          <p>
            ❖ Visited more than 20-good institutions for accreditation, as
            expert member of NBA so far.
          </p>
          ...
          <p>
            ...
            engineering colleges in A.P., Telangana, Maharashtra, Madhya
            Pradesh, Jammu, Uttar Pradesh and Tamilnadu.
          </p>
          <p>
          ...
          <p>
            ❖ Established SC/ST book bank at Library of UCEV during 2013-15.
          </p>
          <p>❖ TCS MoU under TAAP is executed during 2015 as TPO at UCEV.</p>
          <p>❖ Executed THREE MoUs with ECE department during 2020-21.</p>
          <p>
            ❖ Trained students through Virtual labs using mobile app- first of
            its kind!
          </p>
          <p>
            ❖ Given about 23 webinars as Resource person during 2020-21 Lock
            down.
          </p>
        </div>
      </div>
...
export default ForeignUniversityRelations;